...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 18, 2022 lúc 09:56 AM
...
--
-- Cơ sở dữ liệu: `vuamcac`
--
CREATE DATABASE `vuamcac`CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
USE `vuamcac`;
...
(1, 'bù khu', 'helfcilf', '2022-12-18 00:00:00');
...
INSERT INTO `songs` (`id`, `title`, `artist`, `album`, `genre`, `duration`, `path`, `albumOrder`, `plays`, `lyric`) VALUES
...
(3, 'helfcilf', 'Phạm', 'Nguyễn', 'Helfcilf@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2022-12-18 00:00:00', 'assets/images/profile-pics/head_emerald.png');
